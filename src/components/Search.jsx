...
const Search = ({keyword, setKeyword, handleSearch}) => {
  ...
  return (
    <form onSubmit={handleSearch} className={`p-4   flex gap-2 items-center ${isSmallScreen ? 'w-full' : 'w-3/5' } relative pb-3 appearance-none focus:outline-none border-none`}>
